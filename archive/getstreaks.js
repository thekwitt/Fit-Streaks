...
module.exports = {
	...
	async execute(interaction, client) {
		...
		const streaks = [];
		for(let i = 0; i < user_data.streaks.length; i++)
		{
			streaks.push('⭐ ' + (i + 1) + ' | [' + new Date(user_data.New_Day_TS - (86400 * (i + 1))).toISOString().split('T')[0] + '](https://discord.com/channels/' + interaction.guildId + '/' +  + '/1003324962649682072' +  + ')');
		}
